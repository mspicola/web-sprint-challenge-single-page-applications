...
<!-- Form validation is testing that information needed for said form is accurate and not missing all required inputs to render the page -->

1. In 1-2 sentences, define end to end testing.

<!-- End to end testing is used to test the performance of an application under product like circumstances replicating a live setting. Used to simulate what a real user scenario from start to finish. -->
